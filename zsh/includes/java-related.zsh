...
# JAVA
#
#exportIfPresent JAVA_HOME "$HOME/programs/java/current" true \
#  JAVA_OPTS "-Xms128m -Xmx2g -XX:MaxPermSize=512m $COMMON_JAVA_OPTS"

#
# Maven
#
exportIfPresent MAVEN_HOME "$HOME/programs/apache-maven/current" true \
  MAVEN_OPTS "-Xms128m -Xmx2g $COMMON_JAVA_OPTS"
...
#   #  alias maven_command="command mvn"
